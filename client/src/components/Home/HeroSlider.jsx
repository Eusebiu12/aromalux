  ...
  const slides = [
    {
      ...
      title: "Snowy vibes",
      description:
        "See our new winter candle collection",
      ...
      <div className="relative h-full">
        ...
        <div className="relative h-full flex items-center justify-center text-center px-6">
          <div className="max-w-3xl animate-fade-in-up">
            <h1 className="text-5xl md:text-7xl text-yellow-950 font-bold text-foreground mb-4">
              {slide.title}
            </h1>
            <p className="text-xl text-muted-foreground text-yellow-950 mb-8 max-w-2xl mx-auto">
              {slide.description}
            </p>
            <Link
              to={slide.url}
