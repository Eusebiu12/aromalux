      ...
      {/* FORGOT PASSWORD TOGGLE BUTTON/LINK */}
      {
        mode === "signin" && (
          <div className="text-right text-sm">
            <button type="button" onClick={()=> setMode("forgot")} className="text-primary hover:text-accent animate-smoot">
              Forgot Password?
            </button>
          </div>
        )}
        {/* SUBMIT BUTTON */}
        <button type = "submit" disabled={isLoading} className={`w-full py-3 gradient-primary flex justify-center items-center gap-2 text-primary-foreground rounded-lg font-semibold animate-smooth ${
          isLoading 
