      ...
      authUser && (
        <div className="space-y-4 mb-8">
          ...
          <input type="text"
           ...
           <button onClick={handleUpdateProfile} className="flex justify-center items-center space-x-3 p-3 rounded-lg
      ...
      {/* UPDATE PASSWORD FORM */}
        ...
        <div className="space-y-4 mb-8">
          ...
          {showPassword ? "Hide" : "Show"} Passwords
           ...
           <button onClick={handleUpdatePassword} className="flex justify-center items-center space-x-3 p-3 rounded-lg
            glass-card hover:glow-on-hover animate-smooth group w-full">
              {
                isUpdatingPassword ? (<>
                <div className={`w-5 h-5 border-2 botder-white border-t-transparent rounded-full animate-spin`}
                />
