...
console.log("myOrders FROM REDUX:", myOrders);

  const filterOrders = myOrders.filter(
    (order)=> statusFilter === "All"
        ...
        {/* ORDERS LEFT */}    
        {
          filterOrders.length === 0 ? (
            <div className="text-center glass-panel max-w-md mx-auto">
              ...
              <p className="text-muted-foreground">
                {
                  statusFilter === "All" ? "You haven't placed any orders yet" : `No orders with status "${statusFilter} found."` 
                }
              </p>
              </div>) : (
                          ...
                          space-y-4 md:space-y-0">
                            ...
                            <div className="flex items-center space-x-4">
                              <div className="flex items-center space-x-2">
                                  ...
                                  <span className={`px-3 py-1 rounded text-sm font-medium captialize ${getStatusColor(order.order_status)}`}>{order.order_status}</span>
                                </div>
                                <div className="text-right">
                                  <p className="text-sm text-muted-foreground">
                                    Total
                                  </p>
                                  <p className="text-xl font-bold text-primary">{order.total_price} RON</p>
                                </div>
