              ...
              <div className="flex space-x-2 mb-4">
                {
                    ...
                    <div className="flex items-center spacex-4 mb-4">
                      ...
                      {[...Array(5)].map((_, i)=> {
                         ...
                         <span className="text-foreground font-medium">{product.ratings}
                         </span>
                         <span className="text-muted-foreground">({productReviews?.length}) reviews
                           </span> 
                    </div>
                    ...
                    return(
                      ...
                      onClick={()=> setActiveTab(tab)}
                       className={`px-6 py-4 font-medium
                        capitalize transition-all ${activeTab === tab ? "text-primary border-b-2 border-primary"
