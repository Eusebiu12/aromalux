        ...
        <div className="glass-panel">
          <h2 className="text-xl font-semibold text-foreground mb-6">
            ...
            <div className="space-y-2">
              <input type="range" min="0" max="1000" value={priceRange[1]} onChange={(e)=> setPriceRange([priceRange[0],parseInt(e.target.value)])} className="w-full"/>
                ...
                <div className="space-y-2">
                  {
                    [5,4,3,2,1].map(rating=>{
                      return(
                        <button key={rating} onClick={()=> setSelectedRating(selectedRating === rating ?
                          0: rating
                         )}
                         className={`flex items-center space-x-2 w-full py-2 rounded ${
            ...
            <div className="mb-6">
              <h3 className="text-lg font-medium text-foreground mb-3">
                ...
                <div className="space-y-2">
                  {
                    ["in-stock","limited","out-of-stock"].map((status)=>{
                      return(
                        <button key={status} onClick={()=> setAvailability(availability === status ? "" :
                          status
                        )}
               ...
               <div className="mb-6">
                ...
                Category</h3>
                <div className="space-y-2">
                  <button onClick={()=> setSelectedCategory("")} className={`w-full p-2 text-left-rounded ${
      ...
      <div className="flex-1">
        ...
        <div className="mb-8 flex max-[440px]:flex-col items-center gap-2">
          <div className="relative w-[-webkit-fill-available]">
            ...
            <input type="text" placeholder="Search Products..." value={searchQuery} onChange={(e)=>
