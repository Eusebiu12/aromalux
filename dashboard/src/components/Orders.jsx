                  ...
                  <div>
                    <p>
                      ...
                      <p>
                        <strong>
                         Total Amount: 
                        </strong> {order.total_price} RON
                      </p>
                  </div>

                  <div>
                    <select value={selectedStatus[order.id] || order.order_status} onChange={(e)=>
                        ...
                        <div key={item.order_item_id} className="flex items-center gap-4 mb-2 border-b pb-2">
                           {
                            ...
                            <div>
                              ...
                              <p>
                                ...
                                <strong>Total Price:</strong> {item.quantity * item.price} RON</p>
                            </div>
                           </div>
                      );
                    })
