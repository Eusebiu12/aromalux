  ...
  <main className="p-[10px] pl-[10px] md:pl-[17rem] w-full">
    ...
    <div className="max-w-4xl md:px-4 py-8">
      ...
      <div className="bg-white shadow-md rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6 mb-10">
        ...
        />
        <div>
          <p className="text-xl font-medium">Name: {user?.name ?? "Unknown"}</p>
          <p className="text-md text-gray-600">Email: {user?.email ?? "Unknown"}</p>
      ...
      <div className="bg-gray-100 p-7 rounded-2xl shadow-md mb-10">
