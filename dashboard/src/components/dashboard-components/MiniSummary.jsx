...
const MiniSummary = () => {
  ...
  const {
    ...
    newUsersThisMonth,
     currentMonthSales,
     orderStatusCounts,} = useSelector((state)=> state.admin);
      ...
      const summary = [
        {
          ...
          subText: `This month's sales: ${currentMonthSales } RON`,
        ...
        },
        {
          ...
          icon: <TrendingUp className="text-emerald-600"></TrendingUp>
        },
        {
          text: "Low Stock Alerts",
          subText: `${lowStockProducts} products running low on stock`,
          icon: <AlertTriangle className="text-yellow-600"></AlertTriangle>
        },
        {
          text: "Out of Stock Products", // Stoc Epuizat
          subText: `${outOfStockCount} products are out of stock`,
          icon: <AlertTriangle className="text-red-600"></AlertTriangle>
        },
        {
          text: "Revenue Growth Rate",
          subText: `Revenue ${revenueGrowth.includes("+") ? "up" : "down"} by ${revenueGrowth} compares to last month`,
          icon: <BarChart4 className="text-purple-600"></BarChart4>
        },
        {
          text: "New Customers This Month",
          subText: `New customers joined: ${newUsersThisMonth}`,
          icon: <UserPlus className="text-yellow-600"></UserPlus>
        },
      ];
